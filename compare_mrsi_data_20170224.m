...
%% Load Proton Scans.
ll = ll1; proton_lung_injury_20160218(); 
find_FOVs_and_crop_proton_image;
proton1 = proton;
proton_cropped1 = proton_cropped;
ll = ll2; proton_lung_injury_20160218(); 
find_FOVs_and_crop_proton_image; 
proton2 = proton;
...
[~,~,Nt] = size(fnorm8);
data_path = data_path1; find_c13_chemical_shifts_20170124(); cs1 = cs;
data_path = data_path2; find_c13_chemical_shifts_20170124(); cs2 = cs;
...
figure(1000);
subplot(2,2,1);
img1 = show_csi_matrix_20170223(mrsi1/max(mrsi1(:)),spectrascale,0,proton_cropped1,1,...
xgridshift,ygridshift,pyr_idx,lac_idx,ala_idx,1,spectral_zoom,xx,yy);
title('pick a voxel from the top image');

subplot(2,2,3);
img2 = show_csi_matrix_20170223(mrsi2/max(mrsi2(:)),spectrascale,0,proton_cropped2,1,...
xgridshift,ygridshift,pyr_idx,lac_idx,ala_idx,1,spectral_zoom,xx,yy);
